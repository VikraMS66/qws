...
@media only screen and (max-width: 1000px) {
  ...
  <body>
    <div class="mt-1 pt-4 text-start text-dark mx-1 bg-info" style="height: 900px;" >
      <form method="post">
          <div class="card">
            <div class="leftside">
              <img
            ...
            <div class="rightside">
              <form action="">
                ...
                <hr>
                 <h4 class="text-center"><input style=" width: 60px ;" readonly id="pName" name="pName" class="text-center border border-white noselect" value="Not Found"/> Litter Water</h4>
                <hr>
         ...
         ?>
            ...
            <h5><input style=" width: 120px ;" readonly  id="bTotal" name="bTotal" class="text-start border border-white noselect" value="Not Found" /></h5>
                ...
                <p style="font-size: x-small; width:200px;" class='text-warning bg-dark '>Once Placed Order Cannot be Cnacelled.</p>
            </div>
          </div>
        </div>
      </form>
