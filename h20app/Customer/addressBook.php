...
?>
  ...
  <div class="mt-5 pt-5 text-white bg-info " style="background: linear-gradient(60deg, rgba(84,58,183,1) 0%, rgba(0,172,193,1) 100%); ">
              ...
              ?>
               ...
               <div class="container">
                ...
                <div class="col-lg-6 mb-1 mt-2">
                  <?php 
                echo "<a id='".$row['id']."' href='cHomePage.php?info=updateAddress'  name='updateAddress' class='btn btn-info updateAddress'>Edit</a>";
                ?>
                </div>
                <div class="col-lg-6 mb-1 mt-2">
                  <?php
                echo "<a id='".$row['id']."' name='deleteAddress' data-toggle='modal' data-target='#exampleModal' class='delete btn btn-danger mx-4' title='Delete Address?'>Delete</a>";
               ?>
            </div>
            </div>
            </div>
