...
<form method="post" >
            ...
            <div class="card-header bg-info fixed-top mt-5 pt-4">
              <h5 class="text-center">WATER SUPPLIES AVAILABLE</h5>
            </div>
         
         <div class='fixed-top mt-2 mx-5' style=" width: 300px ;" >
         <?php
             // echo "<label id='tagName' class='text-white h5 bg-dark'></label>";
              echo "<input style='width: 65px ;' id='tagName' readonly type='text' class='text-white bg-dark h5 border border-dark' name='tagName' value=".$rowAddressData['tagName'].">";
