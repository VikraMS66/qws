...
?>
<div class=" text-white pt-5 mt-4" style="background-image:url('../images/product.gif'); background-repeat:repeat;" >
...
<form method="post" >
     ...
     <div class="productsAvailable" style="background: linear-gradient(60deg, rgba(84,58,183,1) 0%, rgba(0,172,193,1) 100%); height:650px;">
