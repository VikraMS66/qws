                     ...
                     <div class="card-body p-4 p-md-5">
                        ...
                        <div class='row'>
                         ...
                         <div class='d-grid gap-2 col-6 mx-auto mt-2 mb-0 d-flex justify-content-center align-items-center'>
                                <button type="submit" href='homepage.php?info=supplies' style='width:100px;' id="editProfile" name='editSupplie' class="btn btn-info mb-1 d-grid gap-2 col-6 mx-auto">Save</button>
                        </div>
                      </div>
                  </div>
