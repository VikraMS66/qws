          ...
          <form method="post" action="cHomePage.php?info=orderDetails">
            ...
            ?>
             ...
             <?php 
               ...
               echo "<button id=".$row['id']." style='height:40px;width:".$percentage."' type='submit'  name='selectedOrder' class='btn btn-info text-white mt-1 ml-1 mr-1 details'>Details</button>";
