			...
			array_push($errors, "<div class='alert alert-warning'><b>Address Tag Name Already Exist!</b></div>") ;
				...
				VALUES('$caddTagName','$ID','$caddName','$caddNumber','$caddPincode','$caddGCode','$caddAddress')";
                 ...
                 if (mysqli_num_rows($resultsAddress) == 1) {
                   ...
                   // array_push($errors, "<div class='alert alert-success'><b>Address Added To Address Book Successfully!</b></div>");
...
<?php include('errors.php'); 
    ...
    <form action="" method="post" class="form-horizontal">
		...
		<div class="form-group row text-dark">
			<div class="col-8 offset-4">
				<button  id="addressSave" type="submit"  class="btn btn-primary btn-lg" name="addAddressS">Done</button>
			</div>  
		</div>		      
    </form>
