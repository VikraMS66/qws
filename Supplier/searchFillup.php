  ...
  ?>
    ...
    <div class='row'>
      ...
      <form method='post' action='homepage.php?info=searchfillup'>
        ...
        <?php
         echo "<input name='searchPin'  oninput='javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);' onkeypress='return onlyNumberKey(event)'  id='pincodeEntered' type='text' class='form-control rounded ml-5' style='width:50px;' maxlength='6' minlength='6' value='".$pin."' placeholder='Enter Pincode to Search'/>";
         ?>
