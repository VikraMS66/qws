...
<section  id="parorders" class="pt-5 ">
    ...
    <form method='post' action='homepage.php?info=searchParOrders'>
       <div class='row'>
           ...
           <div class='col-9 text-dark h5'>
              <p><u>To Search use OrderID or Order Status or Pincode or Delivery Address (Name or Number) Capacity.</u></p>
           </div>
       </div>
    </form>
  </div>
           ...
           if (mysqli_num_rows($result) == 1) {
            while($row = mysqli_fetch_assoc($result)) {
                ...
                if($supplieid!=null){
                    ...
                    $sql_query="SELECT * FROM orders WHERE supid='$ID' AND supplyid='$supplieid' ORDER BY date DESC";
