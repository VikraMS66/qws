                        ...
                        <h4 class='text-center bg-warning text-dark pt-1 pb-1 mb-0'>CAPACITY BASED DISTRIBUTION</h4>
                            ...
                            <thead class="thead-dark mt-0">
                                ...
                                { 
                                    ...
                                    $query_cap = "SELECT * FROM orders WHERE supid='$username' AND product='$capacity' AND date BETWEEN '$start' AND '$end'";
                    ...
                    <h4 class='text-center bg-warning text-dark pt-1 pb-1 mb-0'>PINCODE BASED DISTRIBUTION</h4>
                            ...
                            <thead class="thead-dark mt-0">
                                ...
                                { 
                                    ...
                                    $query_pin = "SELECT * FROM orders WHERE supid='$username' AND pincode='$pincode' AND date BETWEEN '$start' AND '$end'";
                    ...
                    <h4 class='text-center bg-warning text-dark pt-1 pb-1 mb-0'>SUPPLIER BASED DISTRIBUTION</h4>
                            ...
                            <thead class="thead-dark mt-0">
                                ...
                                { 
                                    ...
                                    $query_sup = "SELECT * FROM orders WHERE supid='$username' AND supplyid='$id' AND date BETWEEN '$start' AND '$end'";
