               ...
               <div class="col-10">
                   <div class="card-body p-4 p-md-5">
                      ...
                      <div class="form-outline mb-4">
                              ...
                              <input type="text"  id="address" class="form-control" name='address' minlength='1' maxlength='50' required="required"/>
                          </div>
            ...
            if($.isNumeric(pincode) && pincode.length === 6){
             //alert('Hello2');
              if(name.length > 0){
               //alert('Hello');
                $.post(
                  'http://localhost:8013/h20app/Supplier/addNewFillUp.php',
                 ...
                 setTimeout(loadingAgain, 500);
                   ...
                   function loadingAgain(){
                    location.href='homepage.php?info=fillupPoints';
                   }
