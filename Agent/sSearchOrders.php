...
?>
 ...
 <div class="mt-4">
    <form method='post' action='associate.php?info=ssearch_orders'>
       <div class='row'>
           <div class='col-3'>
     ...
     <?php 
                ...
                while($row_get = mysqli_fetch_assoc($res_get)) {
                  $sellid = $row_get['selectedid'];
                }
                }
          
              $sql_query="SELECT * FROM orders WHERE supid='$sellid' AND (id ='$value' OR status LIKE '%".$value."%' OR pincode='$value' OR custName LIKE '%".$value."%' OR custNumber='$value' OR supName LIKE '%".$value."%' OR supNumber='$value' OR product='$value') ORDER BY date DESC";
                       ...
                       <div class="row bg-warning text-dark pt-2 pb-2">
                           <div class="col-6">
                               ...
                               <?php 
                                   ...
                                   if($row['status'] === 'Placed' || $row['status'] === 'OnWay') {
   ...
   // alert(status);
      ...
      $.post(
          ...
          function redirectPage(){
            location.href='associate.php?info=sComplaint';
          }
