...
?>
 ...
 <div class="mt-4">
    <form method='post' action='associate.php?info=search_orderslist'>
       <div class='row'>
           <div class='col-3'>
     ...
     <?php 
              ...
              $sql_query="SELECT * FROM orders WHERE id ='$value' OR status LIKE '%".$value."%' OR pincode='$value' OR custName LIKE '%".$value."%' OR custNumber='$value' OR supName LIKE '%".$value."%' OR supNumber='$value' OR product='$value' ORDER BY date DESC";
