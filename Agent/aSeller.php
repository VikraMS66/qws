...
<section  id="sellers" class="pt-5 mx-3">
...
<table class="table mt-3">
    ...
    <?php
        while($row = mysqli_fetch_assoc($res)) {
           $number = $row['mNumber'];
           $query_check = "SELECT * FROM sellerupdate WHERE sNumber = '$number'";
           $results_check=mysqli_query($conn,$query_check);
     ?>
                         <tr>
     <?php
                         echo"<td>".$row['name']."</td>";
...
$(".updateSeller").click(function (event) {
var id = event.target.id;
//alert(id);
...
$.post(
   ...
   setTimeout(redirectPage, 300);
     ...
     function redirectPage(){
     location.href='associate.php?info=updateSeller';
     }
});

$(".suppliesSeller").click(function (event) {
var id = event.target.id;
//alert(id);
...
$.post(
   ...
   setTimeout(redirectPage, 300);
     ...
     function redirectPage(){
     location.href='associate.php?info=sellerSupplies';
     }
});
