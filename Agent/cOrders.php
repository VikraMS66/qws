 ...
 <div class="mt-4">
    <form method='post' action='associate.php?info=csearch_orders'>
       <div class='row'>
           <div class='col-3'>
               <div class="input-group text-center mx-3 mb-2" style="width:300px;">
                   <input name="searchValue"  id="searchValue" type="text" class="form-control rounded"  maxlength="20" minlength="1" placeholder="Enter a value"/>
     ...
     <?php 
           ...
           $sql_query="SELECT * FROM orders WHERE custid='$custid' ORDER BY date DESC";
