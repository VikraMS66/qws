                      ...
                      <div class='row'>
                       ...
                       <div class="col-4"> 
                          <div class="form-outline mb-4">
                              ...
                              <?php 
                              echo "<input type='text' id='name' readonly class='form-control' maxlength='20' minlength='1' name='name' value='".$cName."'/>";
                              ?>
                          </div>
                         </div> 
                       <div class="col-4"> 
                          <div class="form-outline mb-4">
                              ...
                              <?php 
                              echo "<input type='text' id='number' readonly class='form-control' maxlength='10' minlength='10' name='number' value='".$cNumber."' required='required'/>";
                              ?>
                          </div>
                         </div> 
                       <div class="col-4"> 
                          <div class="form-outline mb-4">
                              ...
                              <?php 
                              echo "<input type='text' id='email' readonly class='form-control' maxlength='50' minlength='1' name='email' value='".$cEmail."'/>";
                              ?>
                          </div>
                         </div> 
                      </div> 
            ...
            //alert(pass);
             ...
             if(message.length < 500 ) {
                ...
                $.post(
                  ...
                  { number: number, name: name, email: email, message: message, type: 'customer' },
                    function(number) {
                    console.log(number);
                  }
                 )
                      ...
                      location.href='associate.php?info=customer';
