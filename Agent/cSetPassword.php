          ...
          <div class="row">
               <div class="col-10">
                   <div class="card-body bg-dark text-white ">
                      ...
                      <div class='row'>
                      <div class="col-8"> 
                        <h3><span class="bg-info text-white">Verify Below Details Before Generating Password.</span><?php echo"<br><br><span>Name: '".$cName."'</span><br>";?>Number: <?php echo"<span id='number'>".$cNumber."</span><br>";?>Email: <?php echo"<span>'".$cEmail."'</span>";?>
                      </div>
                      ...
                      <div class='row mt-5'>
                       <div class="col-6"> 
                          <div class="form-outline mb-4 ">
                              <label class="form-label bg-dark text-white " for="pass">Generated Password</label>
        ...
        $("#updatePass").click(function() {
           ...
           {  
             if(pass.length >=6 ) {
                ...
                $.post(
                  'http://localhost:8013/h20app/Agent/updateCustomerPass.php',
                  { number: number, pass: pass },
                    function(pass) {
                    console.log(pass);
                  }
                 )
                 alert("Password Updated! Share password with customner.");
             }
